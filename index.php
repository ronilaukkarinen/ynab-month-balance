...
<div class="item">
  ...
  <p class="explanation">
    ...
    <span>Tuloista kulujen jälkeen jää vielä <b style="font-weight: 600;" class="green"><?php echo round( $income - $transactions, 0 ); ?> &euro;</b><br></span>
    <span>Tässä kuussa tarvitaan vielä <b style="font-weight: 600;" class="green"><?php echo round( $underfunded, 0 ); ?> &euro;</b><br></span>
  </p>
