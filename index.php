...
<div class="item">
  ...
  <p class="explanation">
    <span>Tämän kuun tulot on <?php echo round( $income, 0 ); ?> &euro;<br></span>
    <span style="display: none;">Tälle kuulle budjetoitu <?php echo round( $budgeted, 0 ); ?> &euro;<br></span>
    <span>Rahaa käytetty <?php echo round( $transactions, 0 ); ?> &euro;<br></span>
    <span>Tuloista kulujen jälkeen jää vielä <b style="font-weight: 500;" class="green"><?php echo round( $income - $transactions, 0 ); ?> &euro;</b><br></span>
    <span>Tässä kuussa tarvitaan vielä <b style="font-weight: 500;" class="green"><?php echo round( $underfunded, 0 ); ?> &euro;</b><br></span>
  </p>
